...
function Framework(options) {
   ...
   * @property {string} [restrictedToEmailDomains] - Set to command seperated list of email domains the bot may interact with, ie "myco.com,mycom2.com".  
  ...
  if ("unauthorizedDomainUserEntersResponse" in options) {
    if (!options.restrictedToEmailDomains) {
      console.error('Ignoring config param unauthorizedDomainUserEntersResponse, ' +
        'which is only used if restrictedToEmailDomains parameter is set.');
    } else {
